         ...
         <section className="login-content overflow-hidden">
            <Row className="no-gutters align-items-center bg-white">
               <Col md="12" lg="6" className='align-self-center'>
                  <Link to="/" className="navbar-brand d-flex align-items-center mb-3 justify-content-center text-primary">
                     ...
                     <Col lg="8">
                        <Card className="d-flex justify-content-center mb-0">
                           <Card.Body>
                              ...
                              <img src={avatars1} className="rounded avatar-80 mb-3" alt="" />
                                 ...
                                 <Row>
                                    <Col lg="12">
                                       <Form.Group className="floating-label form-group">
                                          ...
                                          <Form.Control type="password" className="" id="password" aria-describedby="password" placeholder="xxxxx" />
                                       </Form.Group>
                                    </Col>
                                 </Row>
                                 <Button onClick={() => history('/')} type="button" variant="btn btn-primary">Login</Button>
                              </form>
                           </Card.Body>
                        </Card>
                     </Col>
               ...
               <Col md="6" className="d-lg-block d-none bg-primary p-0 mt-n1  overflow-hidden">
                  <Image src={auth1} className="img-fluid gradient-main" alt="images" />
               </Col>
            </Row>
         </section>
      </Fragment>
