...
const columns = [
  {
    ...
    render: function (row) {
      return `<div class="d-flex align-items-center">
        <img class="rounded img-fluid avatar-60 me-3" src="${row.img}" alt="" loading="lazy">
  ...
  },
  {
    ...
    data: 'statustype',
    render: function (row) {
      return `<span class="badge bg-soft-${row.bgColor} p-2 text-${row.statusColor}">${row.status}</span>`
    }
  },
  {
    title: 'Action',
    data: 'action',
    render: function (row) {
      return `<div class="d-flex justify-content-evenly"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button"><span class="btn-inner">${row.actionadd}</span></a > <div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button"><span class="btn-inner">${row.actionedit}</span></a><div class="d-flex gap-3 justify-content-center"><a class="btn btn-primary btn-icon btn-sm rounded-pill" href="#" role="button"><span class="btn-inner">${row.actionremove}</span></a>`
    }
  }
];
