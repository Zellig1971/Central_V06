...
import { setSetting, theme_scheme } from "../../../../store/setting/actions";
    ...
    <Fragment>
      ...
      >
        <Container fluid className="navbar-inner">
          ...
          <Navbar.Collapse className="collapse bg-dark"> 
            <HorizontalNav />
              ...
              <Dropdown as="li" className="nav-item iq-tour ps-3 ps-lg-0">
                ...
                >
                  ...
                  <img
                    src={Avatar_1}
                    alt="User-Profile"
                    className="theme-color-red-img img-fluid avatar avatar-50 avatar-rounded"
                    loading="lazy"
                  />
                  <img
                    src={Avatar_2}
                  ...
                  <img
                    src={Avatar_3}
                    alt="User-Profile"
                    className="theme-color-royal-blue-img img-fluid avatar avatar-50 avatar-rounded"
                    loading="lazy"
                  />
                  <img
                    src={Avatar_4}
